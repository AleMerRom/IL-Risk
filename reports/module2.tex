...
the rest of the analysis, but the full range graph is in the Appendix~\ref{sec:appendix}.
...
These graphs show the liwuidity distribution for each snapshot, using the colour as concentration of liquidity, The white line
