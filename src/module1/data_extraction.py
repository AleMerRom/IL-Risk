...
from shared.rpc import RpcClient, RpcConfig
...
ARCHIVE_DIR = Path("data/_archive/module1_snapshots/paul_end_of_day_2025-10-2026-03")
MODULE1_RESULTS_DIR = Path("data/results/module_1")
MODULE1_FILES = [
    "swap_events.parquet",
...
def cmd_swaps(
    ...
    from module1.extract_swaps import compact_swaps, extract_swaps
...
def cmd_mints_burns(
    ...
    from module1.extract_liquidity_events import compact_mints_burns, extract_mints_burns
...
def cmd_collects(
    ...
    from module1.extract_liquidity_events import compact_collects, extract_collects
...
def cmd_slot0(
    ...
    from module1.extract_snapshots import compact_slot0, extract_slot0_daily
...
def cmd_liquidity_snapshots(
    ...
    from module1.extract_snapshots import (
...
def cmd_swap_mid_prices(
    ...
    path = output_path or Path("data/results/module_3/swap_mid_prices.parquet")
...
def cmd_validate(data_dir: Path = typer.Option(Path("data"), "--data-dir")) -> None:
    ...
    from module1.validate_module1 import validate_module1
...
def cmd_onchain_tick_check(
    ...
    from module1.validate_module1 import validate_liquidity_ticks_against_rpc

    rpc, _ = _setup()
    table = validate_liquidity_ticks_against_rpc(
        data_dir, rpc, snapshot_block=snapshot_block, sample_size=sample_size
    )
    path = MODULE1_RESULTS_DIR / "liquidity_tick_spot_check.parquet"
